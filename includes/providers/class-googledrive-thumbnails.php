...
class GoogleDrive_Thumbnails extends Video_Thumbnails_Provider
{
	...
	public function get_thumbnail_url( $id ) {
		if ( $this->setting( 'api_key' ) ) {
			$request = "https://www.googleapis.com/drive/v2/files/$id?fields=thumbnailLink&key=" . $this->setting( 'api_key' );
    ...
    {
        return $settings->description('Required for Google Drive support.')
            ->addField(Refactored_Settings_Field_0_5_0::withKey('api_key')
                ->name('API Key')
                ->type('text')
            );
    }
    ...
    public static function get_tests() {
		return array(
			array(
                ...
                'expected'   => '0B2tG5YeQL99ZUHNja3l6am9jSGM',
				'image_url'  => 'https://lh3.googleusercontent.com/QL3d7Wh7V_qcXnMpXT6bio77RS0veyCZZ0zQbMX6gd-qH7aeIXBkXlcSJVDEyftiiA=s480',
				'image_hash' => '3bc674d8d77b342e633ab9e93e345462',
			...
			array(
                ...
                'expected'   => '0BxQsabDaO6USYUgxSUJ3T0ZBa3M',
				'image_url'  => 'https://lh6.googleusercontent.com/WeOdCsaplJ3am25To1uLZiVYkyrilAQ5rxzhjnyyFc5GAF4QeCF1eq3EMpbP7O5dFg=s480',
				'image_hash' => 'f120755bbd1d35e381cb84a829ac0dfa',
			...
			array(
                ...
                'expected'   => '0B92WKFCDHyg9NTRqYTFjVkZmNlk',
				'image_url'  => 'https://lh3.googleusercontent.com/U_lqaX1o7E9iU75XwCrHZ4pdSi-Vch2F_GK5Ib7WAxgwKTvTl0kMHXm2GxKo1Pcp3Q=s480',
				'image_hash' => '31cf8e05f981c1beb6e04823ad54d267',
			...
			array(
                ...
                'expected'   => '0B9VJd4kStxIVellHZEdXdmdSamM',
				'image_url'  => 'https://lh5.googleusercontent.com/mHn5gESachhZHi-kbPCRbR6RVXZm3bR7oNNXL97LyYjpzV3Eqty71J2Waw0DPnXKKw=s480',
				'image_hash' => '2d0ad4881e4b38de0510a103d2f40dd1',
